...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,x='Vehicle_Type',y='Automobile_Sales',title='Average of Vehicles Sold by Vehicle Type'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graphdcc.Graph(figure=px.line(yearly_data, x='Month', y='Automobile_Sales',title='Total Monthly Automobile Sales in year {}'.format(input_year)))
